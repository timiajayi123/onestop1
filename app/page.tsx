  ...
  const Home = () => {
    ...
    const [showLeftBanners, setShowLeftBanners] = useState(true);
    const [showRightBanners, setShowRightBanners] = useState(true);
          ...
          <div className="relative w-full flex items-center justify-center mt-24 mb-14">
            ...
            {showLeftBanners && (
              <div className="hidden md:flex flex-col gap-6 fixed left-4 top-28 z-50">
                <div className="relative bg-white border border-gray-200 px-5 py-4 rounded-xl shadow-md w-[200px] h-[120px] flex flex-col justify-center hover:shadow-lg transition duration-300">
                  <button
                    className="absolute top-2 right-2 text-gray-400 hover:text-gray-600"
                    onClick={() => setShowLeftBanners(false)}
                  >
                    <X size={16} />
                  </button>
            ...
            {showRightBanners && (
              <div className="hidden md:flex flex-col gap-6 fixed right-4 top-28 z-50">
                <div className="relative bg-white border border-gray-200 px-5 py-4 rounded-xl shadow-md w-[200px] h-[120px] flex flex-col justify-center hover:shadow-lg transition duration-300">
                  <button
                    className="absolute top-2 right-2 text-gray-400 hover:text-gray-600"
                    onClick={() => setShowRightBanners(false)}
                  >
                    <X size={16} />
                  </button>

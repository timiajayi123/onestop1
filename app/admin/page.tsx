...
>
        ...
        <section>
          ...
          <div className="mb-4">
            <input
              ...
              className="w-full max-w-xs p-2 border rounded dark:bg-gray-800 dark:text-gray-100"
            />
          </div>
  ...
  <tr>
    ...
    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">User ID</th>
    ...
    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Address</th>
    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Created At</th>
        <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Paystack Ref</th>
  </tr>
</thead>
...
<tbody className="divide-y divide-gray-200 dark:divide-gray-700">
  {filteredOrders.map((order) => (
    <tr key={order.$id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
      ...
      <td className="px-6 py-4 text-sm font-mono text-gray-700 dark:text-gray-300 truncate max-w-[140px]">
        {order.orderNumber}
      </td>
      ...
      {/* Paystack Ref */}
     <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600 dark:text-blue-400 cursor-pointer hover:underline" onClick={() => navigator.clipboard.writeText(order.paystackRef)}>
  {order.paystackRef || '-'}
</td>
  ...
  <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 transition-colors">
    <div className="relative bg-white dark:bg-gray-900 p-6 rounded-lg w-full max-w-md shadow-lg">
      {/* X Button */}
      <button
        type="button"
        aria-label="Close"
